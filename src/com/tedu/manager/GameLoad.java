...
//	图片集合  使用map来进行存储     枚举类型配合移动(扩展)
	public static Map<String,ImageIcon> imgMap= new HashMap<>();	//左上图片集
	public static Map<String,ImageIcon> imgMap2= new HashMap<>();	//右上图片集
	public static Map<String,ImageIcon> imgMap3= new HashMap<>();	//左下图片集
	public static Map<String,ImageIcon> imgMap4= new HashMap<>();	//右下图片集
...
//		}
		loadObj();
		String Str="image/background/map"+mapId+".gif";
		ElementObj obj=getObj("map");
		ElementObj maps = obj.createElement(Str);
...
//		解耦,降低代码和代码之间的耦合度 可以直接通过 接口或者是抽象父类就可以获取到实体对象
	...
	public static void loadImg() {//可以带参数，因为不同的关也可能需要不一样的图片资源
		String texturl1="com/tedu/text/PlayLeftUpData.pro";
		String texturl3= "com/tedu/text/PlayLeftDownData.pro";//文件的命名可以更加有规律
		String texturl2= "com/tedu/text/PlayRightUpData.pro";
		String texturl4= "com/tedu/text/PlayRightDownData.pro";
		ClassLoader classLoader = GameLoad.class.getClassLoader();
		InputStream texts1 = classLoader.getResourceAsStream(texturl1);
		InputStream texts3 = classLoader.getResourceAsStream(texturl3);
		InputStream texts2 = classLoader.getResourceAsStream(texturl2);
		InputStream texts4 = classLoader.getResourceAsStream(texturl4);
		pro.clear();
		try {
...
//			System.out.println(texts);
		...
		try {
			...
			for(Object o:set) {
				String url=pro.getProperty(o.toString());
				imgMap4.put(o.toString(), new ImageIcon(url));
			}
	...
	public static void loadPlay() {
		loadObj();
		String playStr="0,200,attack1,walk1";
